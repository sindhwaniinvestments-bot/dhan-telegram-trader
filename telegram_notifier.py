...
def send_telegram_message(message_text):
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=10) as response:
            ...
            if res_json.get("ok"):
                print(f"✅ Telegram Digest Sent Successfully to Chat ID: {chat_id}")
                return True
            else:
...
def format_new_trade_alert(trade):
    ...
    msg = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"⏰ *Timestamp:* `{trade.get('entry_date', 'LIVE')}`\n"
...
def format_trade_exit_alert(trade):
    ...
    msg = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"⏰ *Date:* `{trade.get('exit_date', 'LIVE')}`\n"
        f"🤖 *Automated 24/7 Dhan Trade Tracker*"
    )
    return msg

def format_daily_digest_alert(active_trades):
    """Formats a daily 9:00 AM summary briefing of all active signals."""
...
if __name__ == "__main__":
    ...
    print("Testing Daily 9:00 AM Digest Format:\n")
    print(format_daily_digest_alert(sample_trades))
